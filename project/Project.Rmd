...
duke_texts <- cleanup(duke_corpus, c("will", "year", "can", "week", "first", "one", "day", "meet", "use", "care", "new", "work", "help", "north"))
...
# “Image”, “Education”, “Research”, “Society”, “Engagement”

duke_word_category <- c("Image", "Education", "Research", "Education", "Image", "Image", "Image", "Engagement", "climat", "Image", "Education", "Image", "Education", "chang", "Research", "Education", "Society", "Society", "Image", "summer", "Image", "Research", "Image", "Research", NA, "Research", "Research")
...
epfl_texts <- cleanup(epfl_corpus , c("new", "use", "can", "day", "will", "year", "one", "now", "open", "via", "first", "sustain"))
...
epfl_word_category <- c("Image", "Research", "Research", "Image", "Education", "Research", "amp", NA, "Research", "Education", "Research", "Education", "Education", "Education", "Education", "Engagement", "Image", "Research", NA, "Society", "Society", "Engagement", "Engagement")
...
goe_texts <- cleanup(goe_corpus, c("new", "can", "will", "show"))
...
goe_word_category <- c("Research", "Research", "Image", "amp", "Engagement", "Image", "Engagement", "Research", "Image", "Education", "network", "Engamement")
...
harvard_texts <- cleanup(harvard_corpus)
...
harvard_mdf.freq <- harvard_mdf %>%
  select(findFreqTerms(harvard_dtm, 70)) %>%
  summarise_all(sum) %>%
  gather() %>%
  arrange(desc(value))
...
# harvard_word_category <- c("Image", "Education", "Research", "Education", "Image", "Image", "Image", "Engagement", "climat", "Image", "Education", "Image", "Education", "chang", "Research", "Education", "Society", "Society", "Image", "summer", "Image", "Research", "Image", "Research", NA, "Research", "Research")

# duke_word_pair <- as.tibble(pairing(duke_word_dictionary, duke_word_category))

print(harvard_dtm.tfidf)
```
