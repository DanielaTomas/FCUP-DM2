...
manchester_texts <- cleanup(manchester_corpus, c("👇", "can", "just", "will", "get", "well", "one", "help", "now"))
...
manchester_word_category <- c("read", "Society?", "Image", NA, "Engagement", "Image", "Education", "Education", "Engagement", "Image", "Education", "Society", "new", "Research", "Research", "Education", "Education", "Education", "Society", "Research", "Education", "Research")
